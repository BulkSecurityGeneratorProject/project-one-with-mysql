...
import { ProjectOneWithMysqlCoreModule } from 'app/core';
import { ProjectOneWithMysqlAppRoutingModule } from './app-routing.module';
...
@NgModule({
  imports: [
    ...
    ProjectOneWithMysqlSharedModule.forRoot(),
    ProjectOneWithMysqlCoreModule,
    ProjectOneWithMysqlHomeModule,
...
export class ProjectOneWithMysqlAppModule {
